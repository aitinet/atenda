  ...
  return (
    <div className="geral-signup">
      <div className={"container-signup"}>
        <div className={"paper"}>
			{/*<img alt={"Logo"} src={""} className="img-logo-signup"></img>*/}
          <h4 className="h4">⚡ Cadastre-se</h4>
          <div>
            <span className="span">
              👋🏻 Comece seu teste <b>GRATUITO</b> de 3 dias do Whaticket SaaS em
              apenas 3 etapas!{" "}
                ...
                <Grid>
                  <Grid item>
                    <Link
                      ...
                      to="/login"
                      style={{ color: "#00a859", fontWeight: 500 }}
                    >
